        ...
        <div class="container-fluid text-white">
            ...
            <div class="row">
                <ul class="nav responsive-tab nav-material nav-material-white">
                    <li>
                        <a class="nav-link" href="admincp/brand"><i class="icon icon-list"></i>Tất cả nhà sản xuất</a>
                    </li>
                    <li>
                        <a class="nav-link active" href="admincp/brandcontrol"><i class="icon icon-plus-circle"></i>Thêm mới danh mục sản phẩm</a>
                    </li>
                </ul>
            </div>
        </div>
