<div class="navbar-custom-menu">
    <ul class="nav navbar-nav">
                ...
                <li>
                    ...
                    <ul class="menu pl-2 pr-2">
                        ...
                        <li>
                            <a href="#">
                                <div class="avatar float-left">
                                    <img src="./publicAdmin/assets/img/dummy/u4.png" alt="">
                        ...
                        <li>
                            <a href="#">
                                <div class="avatar float-left">
                                    <img src="./publicAdmin/assets/img/dummy/u1.png" alt="">
                        ...
                        <li>
                            <a href="#">
                                <div class="avatar float-left">
                                    <img src="./publicAdmin/assets/img/dummy/u2.png" alt="">
                        ...
                        <li>
                            <a href="#">
                                <div class="avatar float-left">
                                    <img src="./publicAdmin/assets/img/dummy/u3.png" alt="">
                                    <span class="avatar-badge busy"></span>
                                </div>
                                <h4>
                                    Support Team
        ...
        <li class="dropdown custom-dropdown user user-menu ">
            <a href="#" class="nav-link" data-toggle="dropdown">
                <img src="./publicAdmin/assets/img/dummy/u8.png" class="user-image" alt="User Image">
